...
def on_player3_button_b_pressed():
    global sword2
    scene.camera_follow_sprite(Player3)
    if p3_b > 0:
...
def on_player4_button_b_pressed():
    global sword2
    scene.camera_follow_sprite(Player4)
    if p4_b > 0:
        sword2 = sprites.create_projectile_from_sprite(img("""
                . . . . . . . . . . . . . f f f 
                            . . . . . . . . . . . . f 1 1 f 
...
Arrow: Sprite = None
debug = 0
splitScreen.set_split_screen_enabled(True)
...
Pointer_4 = sprites.create(img("""
    ...
    """),
    SpriteKind.Arrow_4)
info.player1.set_life(randint(1, 10))
info.player2.set_life(randint(1, 10))
info.player3.set_life(randint(1, 10))
info.player4.set_life(randint(1, 10))
...
p4_a = 999999999
if debug == 0:
    splitScreen.camera_follow_sprite(splitScreen.Camera.CAMERA1, Player1)
    splitScreen.camera_follow_sprite(splitScreen.Camera.CAMERA2, Player2)
    splitScreen.camera_follow_sprite(splitScreen.Camera.CAMERA3, Player3)
    splitScreen.camera_follow_sprite(splitScreen.Camera.CAMERA4, Player4)
else:
    mySprite = sprites.create(img("""
        ...
        """),
        SpriteKind.food)
    controller.player1.move_sprite(mySprite, 200, 200)
